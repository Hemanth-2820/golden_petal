...
const AboutUs = () => {
  return (
    <div id="about-us-brutalist">
      ...
      <section className="dotted-bg mobile-padding" style={{ padding: '8rem 2rem', borderBottom: '2px solid var(--text-black)' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ fontWeight: 700, letterSpacing: '2px', marginBottom: '3rem', fontSize: '1rem', opacity: 0.6 }}>
            ▼ ABOUT GOLDEN PETAL
          </div>
          
          <h1 className="title-display mobile-text-clamp" style={{ fontSize: 'clamp(3rem, 6vw, 5rem)', lineHeight: 0.9, marginBottom: '3rem', color: '#000000' }}>
          ...
          <div className="flex-row-responsive" style={{ gap: '4rem' }}>
            ...
            <div style={{ flex: '1 1 400px', borderLeft: '8px solid #D4AF37', paddingLeft: '2rem' }}>
      ...
      <section className="mobile-padding" style={{ backgroundColor: '#D4AF37', padding: '6rem 2rem', color: 'white', borderBottom: '2px solid var(--text-black)' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ background: 'var(--bg-white)', color: 'var(--text-black)', display: 'inline-block', padding: '10px 20px', border: '3px solid var(--text-black)', fontWeight: 700, letterSpacing: '2px', marginBottom: '4rem', boxShadow: '4px 4px 0px var(--text-black)' }}>
            ▼ THREE PRINCIPLES
          </div>
          
          <h2 className="title-display mobile-text-clamp" style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)', marginBottom: '4rem' }}>
            WHAT WE BELIEVE.
          </h2>
          
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '3rem' }}>
            <div className="brutalist-card" style={{ padding: '3rem', color: '#000000' }}>
              <h3 style={{ fontSize: '3rem', color: '#D4AF37', marginBottom: '1rem', fontFamily: 'Oswald, sans-serif' }}>01</h3>
              <h4 className="title-display mobile-text-clamp" style={{ fontSize: '2rem', marginBottom: '1rem', lineHeight: 1 }}>MEMORIES MATTER.</h4>
            ...
            <div className="brutalist-card" style={{ padding: '3rem', color: '#000000' }}>
              <h3 style={{ fontSize: '3rem', color: '#D4AF37', marginBottom: '1rem', fontFamily: 'Oswald, sans-serif' }}>02</h3>
              <h4 className="title-display mobile-text-clamp" style={{ fontSize: '2rem', marginBottom: '1rem', lineHeight: 1 }}>DETAILS ARE EVERYTHING.</h4>
            ...
            <div className="brutalist-card" style={{ padding: '3rem', color: '#000000' }}>
              <h3 style={{ fontSize: '3rem', color: '#D4AF37', marginBottom: '1rem', fontFamily: 'Oswald, sans-serif' }}>03</h3>
              <h4 className="title-display mobile-text-clamp" style={{ fontSize: '2rem', marginBottom: '1rem', lineHeight: 1 }}>JOY IS NOT A TABOO.</h4>
      ...
      <section className="mobile-padding" style={{ backgroundColor: 'var(--bg-white)', padding: '6rem 2rem', color: 'var(--text-black)', borderBottom: '2px solid var(--text-black)' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ fontWeight: 700, letterSpacing: '2px', marginBottom: '2rem', fontSize: '1rem', opacity: 0.6 }}>
            ▼ WHAT'S INSIDE
          </div>
          
          <h2 className="title-display mobile-text-clamp" style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)', marginBottom: '2rem' }}>
            WHAT'S INSIDE.
          </h2>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem' }}>
            {[
              ...
              <div key={i} className="brutalist-card" style={{ display: 'flex', flexDirection: 'column', padding: 0 }}>
                <div style={{ position: 'relative', height: '250px', borderBottom: '4px solid var(--text-black)' }}>
                ...
                <div style={{ padding: '1.5rem' }}>
                  <h4 className="title-display mobile-text-clamp" style={{ fontSize: '1.5rem', marginBottom: '0.5rem', lineHeight: 1 }}>{feature.title}</h4>
      ...
      <section className="mobile-padding" style={{ backgroundColor: '#000000', padding: '8rem 2rem', color: 'var(--bg-white)' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ fontWeight: 700, letterSpacing: '2px', marginBottom: '3rem', fontSize: '1rem', opacity: 0.6, textTransform: 'uppercase' }}>
            ▼ AS SEEN IN
          </div>
          
          <h2 className="title-display mobile-text-clamp" style={{ fontSize: 'clamp(3rem, 6vw, 5rem)', marginBottom: '4rem', color: 'var(--bg-white)' }}>
            THE CITY IS TALKING.
          </h2>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1rem' }}>
            <div style={{ backgroundColor: 'var(--bg-white)', color: '#000000', padding: '3rem 4rem' }}>
              <div style={{ fontSize: '5rem', color: '#D4AF37', lineHeight: 1, marginBottom: '1rem', fontWeight: 900, fontFamily: 'Arial, sans-serif' }}>“</div>
      ...
      <section className="mobile-padding" style={{ backgroundColor: '#D4AF37', padding: '10rem 2rem', color: 'white' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          <div style={{ fontWeight: 700, letterSpacing: '4px', marginBottom: '2rem', fontSize: '0.8rem', opacity: 0.9 }}>
            ▼ WHERE WE ARE
          </div>
          
          <h2 className="title-display mobile-text-clamp" style={{ fontSize: 'clamp(2.5rem, 5vw, 7rem)', lineHeight: 0.9, marginBottom: '2.5rem', letterSpacing: '-1px', color: '#FFFFFF' }}>
