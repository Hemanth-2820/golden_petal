      ...
      <div style={{ maxWidth: '500px', width: '100%', border: '4px solid #000', backgroundColor: '#FFF', padding: '3rem', position: 'relative', boxShadow: '-8px 8px 0px #000' }}>
        ...
        <form onSubmit={handleRegister}>
          <div style={{ marginBottom: '1.5rem' }}>
            <label style={{ display: 'block', fontWeight: 700, marginBottom: '0.5rem', fontSize: '1.1rem', color: '#000' }}>Full Name <span style={{ color: '#D4AF37' }}>*</span></label>
            <input 
              type="text" 
              required
              value={name}
          ...
          <button 
            type="submit" 
            disabled={loading}
            style={{ width: '100%', backgroundColor: '#D4AF37', color: '#FFF', border: '2px solid #000', padding: '15px 0', fontSize: '1.3rem', fontWeight: 800, cursor: loading ? 'not-allowed' : 'pointer', transition: 'all 0.2s', textTransform: 'uppercase', boxShadow: '4px 4px 0px #000' }}
          >
